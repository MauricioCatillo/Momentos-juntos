    ...
    return (
        <div className="h-full flex flex-col bg-stone-50 dark:bg-stone-900">
            ...
            <form
                ...
                className="p-3 pb-[calc(0.75rem+env(safe-area-inset-bottom))] bg-white/95 dark:bg-stone-800/95 backdrop-blur-xl border-t border-stone-200 dark:border-stone-700"
            >
