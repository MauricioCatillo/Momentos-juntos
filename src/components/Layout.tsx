...
export const Layout: React.FC = () => {
    ...
    return (
        <div className="relative min-h-screen min-h-[100dvh] overflow-x-hidden md:px-5 md:py-5">
            ...
            <div className="relative mx-auto flex min-h-screen min-h-[100dvh] w-full max-w-[28rem] flex-col overflow-x-hidden bg-[color:var(--surface-1)] md:min-h-[calc(100dvh-2.5rem)] md:max-h-[58rem] md:rounded-[2rem] md:border md:border-white/50 md:shadow-[0_32px_90px_rgba(77,42,55,0.24)] dark:md:border-white/10">
                <div
