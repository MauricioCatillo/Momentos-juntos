...
export const Layout: React.FC = () => {
    ...
    return (
        <div className="relative min-h-screen min-h-[100dvh] overflow-x-hidden md:px-5 md:py-5">
            ...
            <div className="relative mx-auto flex h-screen h-[100dvh] w-full max-w-[28rem] flex-col bg-[color:var(--surface-1)]/60 backdrop-blur-sm md:h-auto md:min-h-[calc(100dvh-2.5rem)] md:max-h-[58rem] md:overflow-hidden md:rounded-[2rem] md:border md:border-white/[0.08] md:shadow-[0_32px_90px_rgba(0,0,0,0.25)] dark:md:border-white/[0.06]">
                <div
